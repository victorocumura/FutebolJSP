<%@ page import="TabelasDAO.JogadoresDAO" %>
<%@ page import="Tabelas.Jogadores" %>
	...
	<body>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
		  <div class="container-fluid">
		    <a class="navbar-brand" href="/FutebolJSP">FutebolJSP</a>
		...
		<div class="container">
			...
			<form method="post" action="jogadoresServlet">
				<fieldset>
				...
				<fieldset>
					<label for="clubes_codigo" class="form-label">Clube:</label>
					<select name="clubes_codigo" class="form-control">
						<%
			...
			<table class="table table-hover">
				...
				<tbody>
					<%
						...
						List<Jogadores> jogador = jogadoresDAO.pesquisarTodos();
						
						for(Jogadores jogadores : jogador) {
					%>
						<tr>
							<td><%= jogadores.getCodigo() %></td>
							<td><%= jogadores.getNome() %></td>
							<td><%= jogadores.getPosicao() %></td>
							<td><%= jogadores.getPais() %></td>
							<td><%= jogadores.getClubes().getNome() %></td>
						</tr>
					<% } %>
				</tbody>
			</table>
